...
namespace Mango.Service.Shopping.Cart.API.Migrations
{
    ...
    [Migration("20240507094503_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mango.Service.Shopping.Cart.API.Models.CartDetails", b =>
                {
            ...
            modelBuilder.Entity("Mango.Service.Shopping.Cart.API.Models.CartHeader", b =>
                {
                    b.Property<int>("CartHeaderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TblCartHeader");
                });

            modelBuilder.Entity("Mango.Service.Shopping.Cart.API.Models.CartDetails", b =>
                {
                    b.HasOne("Mango.Service.Shopping.Cart.API.Models.CartHeader", "CartHeader")
                        .WithMany()
